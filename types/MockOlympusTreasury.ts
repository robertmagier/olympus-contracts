...
export interface MockOlympusTreasuryInterface extends utils.Interface {
  functions: {
...
export type ChangeActivatedEventFilter = TypedEventFilter<ChangeActivatedEvent>;

export type ChangeQueuedEvent = TypedEvent<
  [number, string],
  { managing: number; queued: string }
>;

export type ChangeQueuedEventFilter = TypedEventFilter<ChangeQueuedEvent>;
...
export type ReservesManagedEventFilter = TypedEventFilter<ReservesManagedEvent>;
...
export type RewardsMintedEventFilter = TypedEventFilter<RewardsMintedEvent>;
...
export interface MockOlympusTreasury extends BaseContract {
