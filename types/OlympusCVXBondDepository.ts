...
export interface OlympusCVXBondDepositoryInterface extends utils.Interface {
  functions: {
...
export interface OlympusCVXBondDepository extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OlympusCVXBondDepositoryInterface;
